...
export const SubmissionDetailPanel: React.FC<SubmissionDetailsPageProps> = ({
  ...
  const {
    ...
    status,
    language: { id: languageId, version: languageVersion, name: languageName },
                  ...
                  <Card.Body pt={0}>
                    ...
                    <VStack align="stretch" gap={1.5} fontSize="sm">
                      <HStack justifyContent="space-between">
                        ...
                        <Text fontWeight="medium">{timeExecutionInMs}</Text>
                      </HStack>
                      <HStack justifyContent="space-between">
                        <HStack>
                        ...
                        <Text fontWeight="medium">{memoryUsageInKb}</Text>
                      </HStack>
                      <HStack justifyContent="space-between">
                        <HStack>
              ...
              {testcases.map((tc) => {
                ...
                const itemBgConditional = // Logic bg được đưa trực tiếp vào prop
                  tc.status === SubmissionTestcaseStatus.Success
                    ...
                    : tc.status === SubmissionTestcaseStatus.WrongAnswer ||
                        tc.status === SubmissionTestcaseStatus.CompileError ||
                        tc.status === SubmissionTestcaseStatus.RuntimeError
                      ? {
                          _light: "red.50",
                          _dark: "red.800",
                        }
                  ...
                  >
                    <Card.Body p={3}>
                      ...
                      {(tc.runtimeMs || tc.memoryUsedKb) && (
                        ...
                        >
                          {tc.runtimeMs && (
                            <Text>Thời gian: {tc.runtimeMs}ms</Text>
                          )}
                          {tc.memoryUsedKb && (
